...
- Use Luna medium for bounded mechanics and Luna high for ordinary parent and child work. Escalate directly to Sol 5.6 medium for difficult diagnosis, interacting invariants, substantive Luna failure, conflicting evidence, or high-impact review; do not require Luna xhigh first. Luna xhigh/max and Sol high/max are manual-only. Astra low is reserved for stuck/looping work or repeated concrete failures after Sol medium. Route child scouting, research, tests, verification, focused review, and eligible frozen writer slices to Luna high by default.
